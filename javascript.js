...
function rotate_room(room_object) {
  ...
  var new_class = room_div.className.replace(new RegExp('_rotate_' + rotation, 'g'), '_rotate_' + new_rotation);
  ...
  for (var i = 0; i < room_div.childNodes.length; i++) {
    new_class = room_div.childNodes[i].className.replace(new RegExp('_rotate_' + rotation, 'g'), '_rotate_' + new_rotation);
...
function draw_room(room_object) {
  ...
  for (i = 0; i < room_object.room_nodes.length; i++) {
    ...
    for (var j = 0; j < node_object.style_classes.length; j++) {
      node_div.className += ' ' + node_object.style_classes[j] + '_rotate_' + rotation;
    }
